...
For a list of effects see the section \hyperref[sec:orgc38455f]{List of Effects}
...
\label{sec:orgc2f0e3f}

\subsection{Less precise Attributes}
\label{sec:org124e51f}
...
\label{sec:orgebd79c4}

\subsection{Ambushed by Goblins}
\label{sec:org096c6df}
