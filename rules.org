...
- Remove: To remove an aspect you need to make a check. Reduce the AV of the aspect by the AP of the check.
- Resistance: Aspects can resist being removed. Reduce any attempt to remove the aspect by its resistancce. Each point of resistance costs 1 AP. The costs double in line with other modifications.
#+end_short
...
- Equipment: Characters may initially have any item that they could aquire using buying, crafting, or gathering if they always take the average on checks.
- Buying: Make a finances check to create the items aspects. On success get the item and a negative aspect \aspect{Expences} worth the same amount of AP on your finances for some time.
...
** How To: Bribe
To Bribe someone you need to give them more than they can normally comfortably afford. This means you need to create the \aspect{bribe} with an AV of at least their finances value plus applicable aspects. The \aspect{bribe} may need to be [[#sec:aspects_enduring][enduring]] to cover a longer timespan.
...
#+begin_quote
*Hide in Plain Sight* (25): You can disapear from sight, like a ninja with a smoke bomb.
#+end_quote
