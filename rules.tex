...
For a list of effects see the section \hyperref[sec:orgecf89b1]{List of Effects}
...
\label{sec:orgf379cbe}

\subsection{Less precise Attributes}
\label{sec:org33ba9f0}
...
\label{sec:org9f4f262}

\subsection{Ambushed by Goblins}
\label{sec:orga1ddba5}
